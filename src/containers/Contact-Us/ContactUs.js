...
const ContactUs = ({ alt }) => {
  ...
  return (
    <div
      className={
        alt
          ? "contact-us d-flex flex-row align-items-center alt"
        ...
        <div className="contact-info contact-height col-10 col-md-6 m-0 p-0 d-flex flex-row justify-content-center align-items-center order-1">
          ...
          <div className="contact-details-container">
            <div className="contact-address">
              <div className="contact-address-title">Webarch</div>
              <div>
                <p>
          ...
          <div className="contact-icons">
            ...
            <div className="contact-icon-styles">
              <a
                href="https://www.linkedin.com/company/webarchclub/mycompany/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <GrLinkedin />
            ...
            <div className="contact-icon-styles">
              <a
                href="https://www.facebook.com/webarchclub/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <GrFacebook />
