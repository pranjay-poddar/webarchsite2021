          ...
          <div className="col-md-4  col-lg-4 col-sm-6 col-xs-3  d-flex justify-content-center">
            <div className="main-card">
              <div className="domain">
                ...
                <h4>Web Dev</h4>
                <p>
                  A good website leaves a lasting impression. Design and develop
                  full stack, scalable, responsive websites
                </p>
              </div>
          ...
          <div className="col-md-4 col-lg-4 col-sm-6 col-xs-3 d-flex justify-content-center">
            <div className="main-card">
              <div className="domain">
                ...
                <h4>App Dev</h4>
                <p>
                  Create end-to-end mobile applications with cross platform
                  support and robust functionality
                </p>
              </div>
              <div className="shadowOne"></div>
              <div className="shadowTwo"></div>
          ...
          <div className="col-md-4 col-lg-4 col-sm-6 col-xs-6 d-flex justify-content-center">
            <div className="main-card">
              <div className="domain">
                ...
                <p>
                  Dive into the world of automation and intelligence to master
                  the art of machine learning as a service
                </p>
              </div>
              <div className="shadowOne"></div>
              <div className="shadowTwo"></div>
          ...
          <div className="col-md-4 col-lg-4 col-sm-6 col-xs-6 d-flex justify-content-center">
            <div className="main-card">
              <div className="domain">
                ...
                <p>
                  A picture speaks a thousand words. Unleash your creativity by
          ...
          <div className="col-md-4 col-lg-4 col-sm-6 col-xs-6 d-flex justify-content-center">
            <div className="main-card">
              <div className="domain">
                ...
                <p>
                  The backbone of any organization. Showcase your resource
                  management skills and team strategies
                </p>
              </div>
              <div className="shadowOne"></div>
              <div className="shadowTwo"></div>
